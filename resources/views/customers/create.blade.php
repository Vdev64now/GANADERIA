        ...
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" id="first_name" class="form-control" placeholder="Ej: Don Julio" value="{{ old('first_name') }}" required>
                    @error('first_name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Ej: Ortega" value="{{ old('last_name') }}" required>
                    @error('last_name')
                        <span class="text-danger" style="font-size:12px;">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="phone" id="phone" class="form-control" placeholder="Ej: +505 8888-8888" value="{{ old('phone') }}">
                @error('phone')
                    <span class="text-danger" style="font-size:12px;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group" style="margin-bottom: 20px; flex-direction: row; align-items: center; gap: 10px;">
                <input type="checkbox" name="has_butcher_shop" id="has_butcher_shop" value="1" {{ old('has_butcher_shop') ? 'checked' : '' }} style="width: 18px; height: 18px; cursor: pointer;">
            ...
            <div class="form-group" id="butcher-shop-group" style="margin-bottom: 30px; display: none;">
                ...
                <input type="text" name="butcher_shop_name" id="butcher_shop_name" class="form-control" placeholder="Ej: Carnicería El Novillo Alegre" value="{{ old('butcher_shop_name') }}">
